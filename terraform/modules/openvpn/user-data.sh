...
# VPN subnet for clients (OpenVPN 2.4 requires netmask format, not CIDR)
server 10.8.0.0 255.255.255.0

# Push routes for VPC (OpenVPN 2.4 requires netmask format, not CIDR)
...
# Store client config in SSM (use Advanced tier for large configs)
